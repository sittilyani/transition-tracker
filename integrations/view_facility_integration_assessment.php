...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="info-grid">
            <div class="info-item"><label>Leadership Commitment</label><span><?= $assessment['leadership_commitment'] ?? '—' ?></span></div>
            <div class="info-item"><label>Transition Plan</label><span><?= $assessment['transition_plan'] ?? '—' ?></span></div>
            <div class="info-item"><label>HIV in AWP</label><span><?= $assessment['hiv_in_awp'] ?? '—' ?></span></div>

            <div class="info-item"><label>HRH Gap</label><span><?= $assessment['hrh_gap'] ?? '—' ?></span></div>
            <div class="info-item"><label>Multi-skilled Staff</label><span><?= $assessment['staff_multiskilled'] ?? '—' ?></span></div>
            <div class="info-item"><label>Roving Staff</label><span><?= $assessment['roving_staff'] ?? '—' ?></span></div>

            <div class="info-item"><label>Infrastructure</label><span><?= $assessment['infrastructure_capacity'] ?? '—' ?></span></div>
            <div class="info-item"><label>Space</label><span><?= $assessment['space_adequacy'] ?? '—' ?></span></div>

            <div class="info-item"><label>Service without CCC</label><span><?= $assessment['service_delivery_without_ccc'] ?? '—' ?></span></div>
            <div class="info-item"><label>Waiting Time</label><span><?= $assessment['avg_wait_time'] ?? '—' ?></span></div>

            <div class="info-item"><label>Data Integration</label><span><?= $assessment['data_integration_level'] ?? '—' ?></span></div>
            <div class="info-item"><label>Financing</label><span><?= $assessment['financing_coverage'] ?? '—' ?></span></div>

            <div class="info-item"><label>Disruption Risk</label><span><?= $assessment['disruption_risk'] ?? '—' ?></span></div>
        </div>
