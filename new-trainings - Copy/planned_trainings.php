                            ...
                            <div class="action-btns">
                                <button class="btn btn-primary btn-sm"
                                    onclick="showQR(
                                        ...
                                        '<?php echo htmlspecialchars($base_url . '/participant_form.php?token=' . $t['qr_token'], ENT_QUOTES); ?>'
                                    )">
                                ...
                                <a href="create_training.php?edit=<?php echo $t['training_id']; ?>" class="btn btn-sm" style="background:#fff7ed;color:#b45309;">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="training_participants.php?id=<?php echo $row['id']; ?>" style="color:green;"> Participants</a>
