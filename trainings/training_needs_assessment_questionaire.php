                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <select class="form-select" id="facility_name" name="facility_name" required>
                            ...
                            $sql = "SELECT facility_name, facility_id FROM facilities ORDER BY facility_name";
                            $result = $conn->query($sql);

                            if($result && $result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    echo "<option value='" . htmlspecialchars($row['facility_name']) . "' data-id='" . $row['facility_id'] . "'>" . htmlspecialchars($row['facility_name']) . "</option>";
                                }
                            } else {
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select" name="cadre">
                            ...
                            <?php
                            $result = $conn->query("SELECT cadre_name FROM cadres ORDER BY cadre_name");
                            while ($row = $result->fetch_assoc()) {
                                echo "<option value='" . htmlspecialchars($row['cadre_name']) . "'>" . htmlspecialchars($row['cadre_name']) . "</option>";
                            }
                            ?>
                        </select>
                    </div>
